...
% returns the discretized, linearized model about (Xbar_k,Ubar_k)  车辆动力学方程
...
tmp = expm([Ac Bc_aug; zeros(su+1,sx+su+1)]*Ts);    %B=expm(A)  B=I+A+A^2/2+A^3/3/2+A^4/4/3/2+......PADE近似
