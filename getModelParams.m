...
if ModelNo==1
    ...
    ModelParams.stateindex_theta=7; %virtual position 预测轨迹的导数在目标轨迹的投影
...
elseif ModelNo==2
    ...
    ModelParams.Scale=43;%scale of the car (1 is a 1:43 scale car) %%%%%%%% Fullsize车的放大比例 1:43
    ...
    ModelParams.Cm2=175;
    ModelParams.Cr0=120;
    ModelParams.Cr2=0.5*1.225*0.35*2.5;%0.5*rho*cd*A                      %空气动力风阻系数
