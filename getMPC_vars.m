...
if strcmp(CarModel,'ORCA')
    %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
    % MPC settings %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
    %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
    % prediction horizon %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%   预测步长
    MPC_vars.N = 40;
    % sampling time
    MPC_vars.Ts = 0.02;%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%    计算步长
...
elseif strcmp(CarModel,'FullSize')
    ...
    MPC_vars.bounds = [-1e4,-1e4,-3, 0.25,-3,-1,   0,    -1,-1, 0  ,  -0.25 ,-0.1,-10;
                        1e4, 1e4, 3,   10*0+80/10/3.6, 3, 1, 1e4,     1, 1,10  ,   0.25 , 0.1, 10]';   %%%对状态量的约束：-10000<X<10000 【1, 1,10】为U的约束；[0.25 , 0.1, 10]为det_U的约束

    %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
    % Cost Parameters %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
    %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
    MPC_vars.qC = 0.01*100; % contouring cost
    ...
    MPC_vars.rD= 1e-4; % cost on duty cycle (only used as regularization terms)
    MPC_vars.rDelta= 1e-6; % cost on steering 
